<!-- Modal Detail -->
<div class="modal fade" id="detailModalSosmed" tabindex="-1" aria-labelledby="detailModalSosmedLabel" aria-hidden="true">
...
<script>
    function openDetailModalSos(id, nama, foto, link) {
        document.getElementById('detailJudul').innerText = nama;
        document.getElementById('detailFoto').src = "/storage/" + foto; 
        document.getElementById('link').innerText = link;

        var detailModal = new bootstrap.Modal(document.getElementById('detailModalSosmed'));
        detailModal.show();
    }
</script>